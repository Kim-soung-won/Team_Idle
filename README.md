...
### 트러블1. [User 서비스 이용 간의 불필요한 User 데이터 조회 쿼리 다량 발생, Session을 이용한 개선]

[블로그 링크](https://rlatmddnjs0103.tistory.com/189)
...
### 트러블2. [배치 연산 작업 수정을 통한 성능 70% 개선]

[블로그 링크](https://rlatmddnjs0103.tistory.com/224)
