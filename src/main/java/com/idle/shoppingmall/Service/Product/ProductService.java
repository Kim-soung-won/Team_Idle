...
public class ProductService {
    ...
    public List<Product> findByCategory(String product_category, int startPage, int endPage) {
        return productMapper.findByCategory(product_category, startPage, endPage);
    }
} // end class
